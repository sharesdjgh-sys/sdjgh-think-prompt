...
const QUIZ = [
  ...
  {
    context: "시험 공부 계획이 필요할 때",
    A: "시험 공부 계획 짜줘. 국어, 영어, 수학이 있고 2주 남았어. 수학이 제일 약하고, 하루 3시간 공부할 수 있어.",
    B: "시험 공부 도와줘",
    answer: "A" as const,
    why: "A는 과목, 남은 기간, 약점, 하루 공부 가능 시간을 알려줬어요. 이런 정보가 있어야 나한테 맞는 계획이 나온답니다.",
  },
];
